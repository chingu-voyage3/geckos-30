...
if(isset($_GET['id'])){//if the id has been provided in url
	$artistId = $_GET['id'];
} 
else{
...
$artist = new Artist($con, $artistId); // this is our artist object
 ?>
	...
	<div class="tracklist borderBottom">
		...
		<?php 
			...
			foreach($songIdArray as $songId){
				...
				if($i>5){ // to diplay the top 5 played songs only
					break;
				}
